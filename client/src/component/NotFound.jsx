    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-gradient-to-b from-background to-muted/30">
      <div className="max-w-md w-full mx-auto text-center space-y-8">
        ...
        <div className="relative">
          ...
          <div className="absolute -top-6 -right-6 w-24 h-24 rounded-full bg-primary/10 animate-pulse" />
          <div className="absolute -bottom-2 -left-4 w-16 h-16 rounded-full bg-primary/10 animate-pulse delay-300" />
        </div>
